...
public class cadastroClientes extends javax.swing.JDialog {
    ...
    public cadastroClientes(java.awt.Frame parent, boolean modal, Cliente c) {
        super(parent, modal);
        initComponents();
        this.isEdicao = true;
        ...
        cnh.setText(c.getCarteiraMotorista());
        this.edicao = c;
    }
    ...
    private void initComponents() {
        ...
        btnSalvar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/accept.png"))); // NOI18N
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(cnh, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(cpf, javax.swing.GroupLayout.Alignment.TRAILING)
                            .addComponent(rg)
                            .addComponent(id, javax.swing.GroupLayout.DEFAULT_SIZE, 322, Short.MAX_VALUE)
                            .addComponent(nome)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        String CNH = cnh.getText();

        Cliente reg = new Cliente(ID, Nome, RG, CPF, CNH);
